...
import { c as createExports, s as serverEntrypointModule } from './chunks/_@astrojs-ssr-adapter_CHkBIIys.mjs';
import { manifest } from './manifest_DOsfieYe.mjs';
...
const _args = {
    "middlewareSecret": "e8bfef06-a27d-4834-8438-cde5c9406fe0",
